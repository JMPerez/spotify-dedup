...
const resources = {
  en: {
    translation: {
      ...
      'faq.answer-3': ' The same song can have multiple identifiers on Spotify that both in the same release or in several ones. Spotify only warns about duplicates based on the song identifier, whereas this tool also detects duplicates based on title, artist, and duration similarity.',
